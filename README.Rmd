...
The goal of SurvivalHazardExtraction is to ...

## Installation

You can install the released version of SurvivalHazardExtraction from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("SurvivalHazardExtraction")
```
...
```{r example}
library(SurvivalHazardExtraction)
## basic example code
```
